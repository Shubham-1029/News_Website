...
from .views import RegisterView, UserDetailView, ArticleListView, ArticleDetailView, CommentListView, GrantAuthorView, LoginView, TagListCreateView, TagDetailView, UpdateTagsView, UserArticlesView
...
urlpatterns = [
    ...
    path('tags/<int:pk>/', TagDetailView.as_view(), name='tag-list-update'),
